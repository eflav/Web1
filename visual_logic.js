...
eventHTMLElem('mousemove', 'slider', true, function(event) {
  setMorphFactor('Cube', 'Length', getHTMLElemAttribute('value', 'slider', true));
  setObjTransform('Icosphere2', false, 'position', [getHTMLElemAttribute('value', 'slider', true) - 1, '', ''], false);
  setObjTransform('Icosphere1', false, 'position', [getHTMLElemAttribute('value', 'slider', true) * 3, '', ''], false);
  if (getHTMLElemAttribute('value', 'slider', true) < 0.8) {
    setObjTransform('Icosphere3', false, 'position', [getHTMLElemAttribute('value', 'slider', true) * 1.5, '', ''], false);
  } else {
    setObjTransform('Icosphere3', false, 'position', [getHTMLElemAttribute('value', 'slider', true) * 1, '', ''], false);
  }
  setObjTransform('Icosphere4', false, 'position', [getHTMLElemAttribute('value', 'slider', true) * 2, '', ''], false);
  console.log(getHTMLElemAttribute('value', 'slider', false));
  if (getHTMLElemAttribute('value', 'slider', true) < 0.8) {
    changeVis('Icosphere4', false);
  } else {
    changeVis('Icosphere4', true);
  }
  if (getHTMLElemAttribute('value', 'slider', true) < 0.4) {
    changeVis('Icosphere3', false);
  } else {
    changeVis('Icosphere3', true);
  }
});
